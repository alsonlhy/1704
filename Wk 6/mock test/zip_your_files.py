...
config = {
    'LT_tag': 'Mock_LT1',                              # Tag prefixed to submission
    'LT_name': 'Mock Lab Test 1',                      # Title rendered in terminal
    # Minimum set of files in complete submission        
    'file_names': ['q1.py', 'q2.py', 'q3.py'],
    'test_start_date': '2026-09-21 08:00:00'           # Expect student solutions to have timestamp later
...
class SubmissionClass:
    ...
    def package(self, root_dir='.'):
        ...
        if unmodified:
            print(f'The following files show {self.blink_str("NO CHANGES")} after', str(config['test_start_date']))
        ...
        print(f'Upload this file to Examena: {self.blink_str(zfn, color=self.BOLD_GREEN)}')
