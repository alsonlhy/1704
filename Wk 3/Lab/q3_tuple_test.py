...
def calculate_salary(monthly_sales):
    ...
    commission_rate = (0.05, 0.10, 0.15, 0.18)

    if monthly_sales < 10000:
        commission = commission_rate[0] * monthly_sales

    elif monthly_sales < 15000:
        commission = commission_rate[1] * monthly_sales

    elif monthly_sales < 18000:
        commission = commission_rate[2] * monthly_sales

    else:
        commission = commission_rate[3] * monthly_sales
